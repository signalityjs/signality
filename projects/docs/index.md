...
<div class="info-banner">
  ...
  <div style="display: flex; flex-direction: column; gap: 8px">
    <div class="stacked-avatars">
      ...
      <div class="avatar" style="background-color: #27272A; z-index: 3;"></div>
      <div class="avatar" style="background-color: #262628; z-index: 2;"></div>
      <div class="avatar" style="background-color: #212124; z-index: 1;"></div>
    </div>
