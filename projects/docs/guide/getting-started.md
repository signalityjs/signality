...
.signality-logo svg .gradient-stop-1 {
  animation: gradient-1 4s ease infinite;
}

.signality-logo svg .gradient-stop-2 {
  animation: gradient-2 4s ease infinite;
}

.signality-logo svg .gradient-stop-3 {
  animation: gradient-3 4s ease infinite;
}

.signality-logo svg .gradient-stop-4 {
  animation: gradient-4 4s ease infinite;
}

.signality-logo svg .gradient-stop-5 {
  animation: gradient-5 4s ease infinite;
}

.signality-logo svg .gradient-stop-6 {
  animation: gradient-6 4s ease infinite;
}

@keyframes gradient-1 {
  0%, 100% { stop-color: #E40035; }
  16.66% { stop-color: #F60A48; }
  33.33% { stop-color: #F20755; }
  50% { stop-color: #DC087D; }
  66.66% { stop-color: #9717E7; }
  83.33% { stop-color: #6C00F5; }
}

@keyframes gradient-2 {
  0%, 100% { stop-color: #F60A48; }
  16.66% { stop-color: #F20755; }
  33.33% { stop-color: #DC087D; }
  50% { stop-color: #9717E7; }
  66.66% { stop-color: #6C00F5; }
  83.33% { stop-color: #E40035; }
}

@keyframes gradient-3 {
  0%, 100% { stop-color: #F20755; }
  16.66% { stop-color: #DC087D; }
  33.33% { stop-color: #9717E7; }
  50% { stop-color: #6C00F5; }
  66.66% { stop-color: #E40035; }
  83.33% { stop-color: #F60A48; }
}

@keyframes gradient-4 {
  0%, 100% { stop-color: #DC087D; }
  16.66% { stop-color: #9717E7; }
  33.33% { stop-color: #6C00F5; }
  50% { stop-color: #E40035; }
  66.66% { stop-color: #F60A48; }
  83.33% { stop-color: #F20755; }
}

@keyframes gradient-5 {
  0%, 100% { stop-color: #9717E7; }
  16.66% { stop-color: #6C00F5; }
  33.33% { stop-color: #E40035; }
  50% { stop-color: #F60A48; }
  66.66% { stop-color: #F20755; }
  83.33% { stop-color: #DC087D; }
}

@keyframes gradient-6 {
  0%, 100% { stop-color: #6C00F5; }
  16.66% { stop-color: #E40035; }
  33.33% { stop-color: #F60A48; }
  50% { stop-color: #F20755; }
  66.66% { stop-color: #DC087D; }
  83.33% { stop-color: #9717E7; }
}
