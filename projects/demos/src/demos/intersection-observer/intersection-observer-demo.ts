    ...
    <ng-demo-wrapper [code]="importCode">
      <div class="intersection-card">
        <div class="scroll-container">
          <div #targetBox class="target-box" [class.visible]="isIntersecting()">
            <span class="box-label">{{ isIntersecting() ? 'Visible' : 'Not Visible' }}</span>
          </div>
        </div>
        ...
        <demo-card>
          <div class="status-info">
            <div class="info-row">
              ...
              <span class="info-value" [class.active]="isIntersecting()">
